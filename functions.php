...
// Shortcode to display non-supported countries as a table
add_shortcode('non_supported_countries_table', function() {
    if (!function_exists('get_field')) return '';
    $countries = get_field('non_supported_country', 'option');
