...
require_once get_template_directory() . '/inc/shortcodes/non-supported-countries-table.php';
require_once get_template_directory() . '/inc/shortcodes/supported-countries-table.php';
require_once get_template_directory() . '/inc/shortcodes/money-transfer-calculator.php';
require_once get_template_directory() . '/inc/shortcodes/mtc-ecb.php';